...
async def test_exempt_path_skips_auth():
    ...
    middleware = AuthMiddleware(
        app, authenticator, require_auth=True, exempt_paths={"/.well-known/agent.json", "/health", "/metrics"}
    )
...
async def test_exempt_prefix_skips_auth():
    ...
    middleware = AuthMiddleware(app, authenticator, require_auth=True, exempt_prefixes={"/explorer"})
